...
const JOINT_ATTACH_HAND_LEFT	= 'attach_hand';
...
function int GetJntIndxAttachHandLeft() { return JointNamed( JOINT_ATTACH_HAND_RIGHT ); }
function int GetJntIndxAttachHandRight(){ return JointNamed( JOINT_ATTACH_HAND_LEFT ); }
function int GetJntIndxAttachArmLeft()	{ return JointNamed( JOINT_ATTACH_ARM_LEFT ); }
function int GetJntIndxAttachBackLeft()	{ return JointNamed( JOINT_ATTACH_BACK_LEFT ); }
function int GetJntIndxAttachBackRight(){ return JointNamed( JOINT_ATTACH_BACK_RIGHT ); }
function int GetJntIndxAttachHipLeft()	{ return JointNamed( JOINT_ATTACH_HIP_LEFT ); }
function int GetJntIndxAttachHipRight()	{ return JointNamed( JOINT_ATTACH_HIP_RIGHT ); }

// Attach an actor to an attachment joint
function AttachToHandLeft(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachHandLeft() ); }
function AttachToHandRight(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachHandRight() ); }
function AttachToArmLeft(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachArmLeft() ); }
function AttachToBackLeft(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachBackLeft() ); }
function AttachToBackRight(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachBackRight() ); }
function AttachToHipLeft(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachHipLeft() ); }
function AttachToHipRight(actor a)	{ AttachActorToJoint( a, GetJntIndxAttachHipRight() ); }

// Detach an actor from an attachment joint and return it
function Actor DetachFromHandLeft()	{ return DetachActorFromJoint( GetJntIndxAttachHandLeft() ); }
function Actor DetachFromHandRight(){ return DetachActorFromJoint( GetJntIndxAttachHandRight() ); }
function Actor DetachFromArmLeft()	{ return DetachActorFromJoint( GetJntIndxAttachArmLeft() ); }
function Actor DetachFromBackLeft()	{ return DetachActorFromJoint( GetJntIndxAttachBackLeft() ); }
function Actor DetachFromBackRight(){ return DetachActorFromJoint( GetJntIndxAttachBackRight() ); }
function Actor DetachFromHipLeft()	{ return DetachActorFromJoint( GetJntIndxAttachHipLeft() ); }
function Actor DetachFromHipRight()	{ return DetachActorFromJoint( GetJntIndxAttachHipRight() ); }

///////////////////////////////////////////////////////////////////////////////
// Acquiring inventory items
//
// Acquire a weapon
// TODO: Dropped items stay in inventory, fix this
function AcquireWeapon(Weapon weaponItem)
{
	...
	w = DetachFromHandRight();
	if(w != None)
	{
		// TODO: This is not good, weapon should handle this
		// We get client messages when we pick stuff up. Where?
		w.GotoState('Drop');
	}
	
	AttachToHandLeft( weaponItem );
}

// Acquire a shield
function AcquireShield(Shield shieldItem)
{
	AttachToArmLeft( shieldItem );
}


function bool WantsToPickUp(Inventory item)	{ return true; }
function bool CanPickUp(Inventory item)		{ return true; }
